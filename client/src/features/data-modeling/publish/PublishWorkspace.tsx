    ...
    <Panel>
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="space-y-3">
          ...
          <DiffRow type="Modified" object="Metric certification" impact="Certified exposure requires current validation evidence and human review" />
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            <Button variant="secondary" onClick={markReviewed}><ShieldCheck className="h-4 w-4" /> Approve current review</Button>
