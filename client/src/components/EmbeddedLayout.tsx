      ...
      <header className="shrink-0 border-b border-[#e4e4e7] bg-[#f7f7f8]">
        <div className="flex min-h-[46px] min-w-0 items-center gap-3 px-3 sm:px-4">
          <div className="hidden min-w-0 sm:block">
            <div className="truncate text-[13px] font-medium text-[#202124]">Data Studio</div>
            <div className="truncate text-[11px] text-[#73737a]">Knowledge Center</div>
          </div>
                    ...
                    className={({ isActive }) =>
                      `inline-flex h-8 shrink-0 items-center gap-2 rounded-md px-2.5 text-[13px] transition-colors ${
                        isActive || activeTab.to === tab.to
                          ? 'bg-white text-[#202124] shadow-[0_1px_2px_rgba(24,24,27,0.055)] ring-1 ring-[#e4e4e7]'
                          : 'text-[#6f6f76] hover:bg-[#ededee] hover:text-[#202124]'
                      }`
                    }
                  >
