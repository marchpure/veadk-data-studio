...
SourceSkillCandidateType = Literal[
    "schema_map",
    "data_profile",
    "relationship",
    "data_truth",
...
SourceSkillReviewStatus = Literal["suggested", "verified", "rejected", "stale"]
SourceSkillValidationStatus = Literal["not_run", "passed", "warning", "failed"]
