...
import { Panel, PanelHeader, ScoreBar, SectionTitle, StatusPill } from './modelingUi'
      ...
      <DialogContent className="max-h-[94vh] max-w-[1280px] overflow-y-auto border-[#2a2a2a] bg-[#1a1a1a] p-0 text-white custom-scrollbar">
        <DialogHeader className="border-b border-[#2a2a2a] px-5 py-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <StatusPill tone="info">Profile-first generation</StatusPill>
          </div>
          <DialogDescription>
...
function DatasourceStep({
  ...
  return (
    <div className="space-y-4">
      <Panel>
        <PanelHeader title="Choose Data" subtitle="Select a profiled datasource for semantic generation." />
    ...
    <Panel>
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_300px]">
        ...
        <div className="rounded-md border border-[#2a2a2a] bg-[#181818] p-4">
          ...
          <p className="mt-2 text-sm text-[#cfcfcf]">Generation runs as a persisted backend job and creates a draft model when complete.</p>
