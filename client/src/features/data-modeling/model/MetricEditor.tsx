      ...
      <Panel>
        ...
        <div className="grid gap-4 p-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {(['draft', 'reviewed'] as CertificationStatus[]).map(status => (
            ...
            <p className="mt-2 text-xs text-[#8f8f8f]">Certified is assigned only after validation evidence and publish review approve the current model definition.</p>
          </div>
        </div>
      </Panel>
