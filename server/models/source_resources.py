...
SOURCE_RESOURCE_TYPES = ("pdf", "web", "feishu_doc", "feishu_sheet", "database_catalog", "database_schema", "database_table")
SOURCE_SYNC_MODES = ("manual", "scheduled")
SOURCE_RESOURCE_STATUSES = ("pending", "syncing", "understanding", "needs_confirmation", "ready", "failed")
