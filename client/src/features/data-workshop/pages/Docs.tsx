...
export function ConnectionDocs() {
  ...
  return <div className="dw-page dw-docs-page">
    ...
    {status.identity_status !== 'ready' && <div className="dw-identity-warning" role="alert"><AlertCircle size={18} /><div><strong>Identity / JWKS 尚未配置</strong><span>请在 OpenConnector Console 配置企业 Identity Provider 与 JWKS，完成后重试。</span></div><div className="dw-button-row"><a className="dw-button dw-button-secondary" href="/connections/access/identity">打开身份配置</a><button className="dw-button dw-button-secondary" onClick={() => void load()}>重试</button></div></div>}
