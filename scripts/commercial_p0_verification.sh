...
BASE_SHA="${BASE_SHA:-e9358ea56554cc0ecdf93b723359eee711cb13b1}"
...
start_backend() {
  ...
  (
    ...
    APP_SECRET="${APP_SECRET:-commercial-p0-verification-local-secret}" \
...
run_collector() {
  ...
  E2E_EMAIL="${E2E_EMAIL:-${MASTER_USER_EMAIL:-admin@example.com}}" \
  E2E_PASSWORD="${E2E_PASSWORD:-${MASTER_USER_PASSWORD:-commercial-p0-password}}" \
