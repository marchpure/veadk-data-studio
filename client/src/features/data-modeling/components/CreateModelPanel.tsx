...
import { EmptyState, ErrorState, Panel, PanelHeader, ScoreBar, SectionTitle, StatusPill } from './modelingUi'
              ...
              <Panel>
                ...
                <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_280px]">
                  ...
                  <div className="rounded-md border border-[#2a2a2a] bg-[#181818] p-4">
                    ...
                    <p className="mt-2 text-sm text-[#cfcfcf]">Start by running query_metric on the published version. Draft edits must be validated and reviewed before consumers can use them.</p>
  ...
  return (
    <div className="space-y-4">
      <Panel>
        ...
        {loading && <div className="p-4 text-sm text-[#cfcfcf]">Loading datasources...</div>}
        ...
        <div className="grid gap-3 p-4 md:grid-cols-3">
          {datasources.map(item => {
            ...
            >
              ...
              <div className="mt-1 text-xs uppercase text-[#8e8e8e]">{item.kind} · {item.sourceType}</div>
          ...
          <div className="space-y-3">
            <label className="block text-xs font-medium text-[#9a9a9a]">
              ...
              <input
                ...
                placeholder={profile?.name ? `${profile.name} domain` : 'Business domain'}
  ...
  return (
    <Panel>
      <PanelHeader
        ...
        subtitle="Generation creates a draft only from already verified source suggestions; publish remains validation- and review-gated."
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_300px]">
        ...
        <div className="rounded-md border border-[#2a2a2a] bg-[#181818] p-4">
          ...
          <p className="mt-2 text-sm text-[#cfcfcf]">Generation reads Source Understanding evidence and creates a persisted draft only when candidates were already verified by a reviewer.</p>
          <Button className="mt-4 w-full" variant="brand-primary" onClick={completed ? onComplete : onRun} disabled={running}>
            {completed ? 'Continue to Explore' : running ? 'Generating...' : 'Start AI generation'}
