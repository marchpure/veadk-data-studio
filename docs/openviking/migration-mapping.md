...
| `TasksRoute` and task normalization | `routes/tasks/**` | Preserve hosted task status, detail, failure, and retry UI. | Hosted tasks rendered; completed and failed states; missing resource restored and live retry completed with 5 records rebuilt |
...
- Hosted task retry was exercised against real failed task
  `660de695-de4a-4c4f-9ef8-4268af5202fb`. After restoring its missing resource,
  W6 retry task `e43efa5a-ddd8-4ae3-b5a4-d9c794a571ea` completed with 5 records
  rebuilt and no failed records.
