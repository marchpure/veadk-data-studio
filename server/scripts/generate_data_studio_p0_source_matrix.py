...
def render_markdown() -> str:
    ...
    lines = [
        ...
        "| Blocked projection/modeling | MSSQL, MongoDB, DynamoDB | Current query or connection capability exists, but governed source snapshot/projection/modeling handoff is incomplete. |",
        "",
